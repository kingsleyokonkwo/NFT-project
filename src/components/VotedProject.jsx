        ...
        <div className="voteproject-page">
            ...
            <div className="voteform-input">
                ...
                <div className="voteFormInput-copy">
                    <input className='vote-input' type="text" placeholder="0x0e09fabb73bd3ade0a17ecc321fd13a19e8..."/>
            ...
            <div className="voteAbout-project">
                <h3>About Project</h3>
                <p>Eget neque, mauris ultrices ullamcorper. Ac blandit quam interdum magna turpis est. Quam sollicitudin in tristique vel nunc id adipiscing. Etiam praesent montes, ridiculus id viverra sit odio elementum. Feugiat ac consequat lectus sem lectus aenean turpis cursus.</p>
            </div>
            ...
            <div className="voteNft-ad"  style={{ backgroundImage: `url(${bg})`, backgroundSize: "contain", backgroundPosition: "right", backgroundRepeat: "no-repeat"}}>
