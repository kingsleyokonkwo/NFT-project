  ...
  const assetItem = (props) => {
    return (
      <div className='asset-item'>
          <img className='asset-img' src={props.img} alt="asset image" />
          ...
          <span className='asset-change' style={{ color: props.loss ? "#EF4444" : "#10B981" }}>{props.change}</span>
          <span className='asset-price'>{props.marketPrice}</span>
          {/* add the dropdown when hover on more */}
          <img className='more-sign' src={more} alt="more..." onMouseEnter={()=> setDropdown(true)} onClick={()=> setDropdown(false)}/>
