    ...
    <div className='editProfile-container'>
        ...
        <form>
            <div className="formInput">
                ...
                <input className='cryptoinput' type="text" placeholder='John Doe'/>
            </div>
            <div className="formInput">
                <label>Email</label>
                <input className='cryptoinput' type="text" placeholder='johndoe@email.com'/>
            </div>
            <div className="formInput">
                <label>Username</label>
                <input className='cryptoinput' type="text" placeholder='Johndoe123'/>
            </div>
